...
# 2. Launch the Swift binary in the background (prioritize App Bundle)
if [ -f "/Applications/AxiomOS.app/Contents/MacOS/AxiomOS" ]; then
    "/Applications/AxiomOS.app/Contents/MacOS/AxiomOS" > /dev/null 2>&1 &
elif [ -f "/Users/sreeramlagisetty/Desktop/Axiom/bin/AxiomOS.app/Contents/MacOS/AxiomOS" ]; then
    "/Users/sreeramlagisetty/Desktop/Axiom/bin/AxiomOS.app/Contents/MacOS/AxiomOS" > /dev/null 2>&1 &
